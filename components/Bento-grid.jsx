...
export function FeaturesSectionDemo() {
  const features = [
    ...
    {
      title: "Connect Instantly, Care Globally",
      description:
        "With our ultra-fast, globally-distributed, AI-powered magic, you can connect with certified doctors anytime, anywhere.",
  ...
  return (
    <div className="relative z-20 py-10 lg:py-20 max-w-5xl mx-auto">
      ...
      <div className="relative ">
        <div className="grid grid-cols-1 lg:grid-cols-4 mt-8 xl:border rounded-md dark:border-neutral-800">
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-4 px-2 gap-4 h-full">
      <div className="w-full p-3 mx-auto bg-white dark:bg-neutral-900 shadow-lg group h-full">
        <div className="flex flex-1 w-full h-full flex-col -mb-4">
          <img
            src="/banner2.png"
            alt="header"
            width={300}
            height={200}
            className="h-60 w-full aspect-square object-cover object-left-top rounded-sm"
          />
        </div>
      </div>
...
export const SkeletonThree = () => {
  return (
    <a
      ...
      target="__blank"
      className="relative flex gap-4 h-full group/image"
    >
      <div className="w-full mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2 relative">
          ...
          <img
            ...
            width={200}
            height={200}
            className="h-50 mt-8 w-full aspect-square object-cover object-center rounded-sm blur-none group-hover/image:blur-md transition-all duration-200"
          />
        </div>
      </div>
    </a>
...
export const SkeletonTwo = () => {
  ...
  return (
    <div className="relative flex flex-col items-start p-2 gap-4 h-full overflow-hidden">
      <div className="flex flex-row -ml-10">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileTap="whileTap"
            className="rounded-xl -mr-2 mt-4 p-1 bg-white dark:bg-neutral-800 dark:border-neutral-700 border border-neutral-100 shrink-0 overflow-hidden"
          >
            <img
              src={image}
              alt="bali images"
...
export const SkeletonFour = () => {
  return (
    <div className="h-48 md:h-48  flex flex-col -mr-4 mt-20 items-center relative bg-transparent dark:bg-transparent">
      <Globe className="absolute right-20 md:-right-24 -bottom-40 md:-bottom-36" />
    </div>
  );
};
